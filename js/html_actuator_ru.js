class HTMLActuator {
  constructor() {
    ...
    this.linkTop = document.getElementById('linkTop');
  ...
  setupEventListeners() {
    if (this.linkTop) {
      this.linkTop.onclick = this.toggleLeaderboard.bind(this);
    }

    if (this.nickInput) {
      this.nickInput.oninput = this.resizeNickInput.bind(this);
    }
  }
